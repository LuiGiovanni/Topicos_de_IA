...
winrecord_MC_epsilon = iteration(1000, MC, 'MC-epsilon', epsilon_greedy_policy)
winrecord_QL_epsilon = iteration(1000, QL, 'QL-epsilon', epsilon_greedy_policy)
winrecord_TD_epsilon = iteration(1000, TD, 'TD-epsilon', epsilon_greedy_policy)
winrecord_MC_best = iteration(1000, MC, 'MC-best', best_policy)
winrecord_QL_best = iteration(1000, QL, 'QL-best', best_policy)
winrecord_TD_best = iteration(1000, TD, 'TD-best', best_policy)
